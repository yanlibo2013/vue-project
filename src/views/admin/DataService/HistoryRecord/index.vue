<template>
  <div class="history-record">
    ...
    <el-table :data="tableData" style="width: 100%;">
      ...
      <el-table-column prop="" label="申请资源"></el-table-column>
      <el-table-column prop="" label="关联应用"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    handleClick(val) {
      if (val == "pull") {
        this.$router.push({ path: "/admin/dataservice/pull", query: "" });
      }

      if (val == "push") {
        this.$router.push({ path: "/admin/dataservice/push", query: "" });
      }
    }
  }
};
